...
<body>
	...
	<!-- Page Content  -->
		<div id="content" class="p-4 p-md-5 pt-5">
			<h2 class="mb-4"  align="center"><u>Current Transactions</u></h2>
				...
				<table id="example"
					...
					<tbody>
						<c:forEach var="rental" items="${rental}">
							<c:url var="returning" value="return">
							...
							<tr>
								...
								<td>${rental.amount}</td>
								<td><a href="${returning}">Return</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
